var U=s=>{throw TypeError(s)};var z=(s,t,e)=>t.has(s)||U("Cannot "+e);var _=(s,t,e)=>(z(s,t,"read from private field"),e?e.call(s):t.get(s)),T=(s,t,e)=>t.has(s)?U("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(s):t.set(s,e),B=(s,t,e,i)=>(z(s,t,"write to private field"),i?i.call(s,e):t.set(s,e),e);var m,Z;class f1{constructor(t){T(this,m);T(this,Z,new Set);B(this,m,t)}get current(){return _(this,m)}set current(t){_(this,m)!=t&&(B(this,m,t),_(this,Z).forEach(e=>e(t)))}on(t){return _(this,Z).add(t),()=>_(this,Z).delete(t)}}m=new WeakMap,Z=new WeakMap;const K=s=>new f1(s),O=Symbol.for("atomico.hooks");globalThis[O]=globalThis[O]||{};let P=globalThis[O];const p1=Symbol.for("Atomico.suspense"),X=Symbol.for("Atomico.effect"),Q=Symbol.for("Atomico.layoutEffect"),W=Symbol.for("Atomico.insertionEffect"),q=(s,t,e)=>{const{i,hooks:o}=P.c,c=o[i]=o[i]||{};return c.value=s(c.value),c.effect=t,c.tag=e,P.c.i++,o[i].value},w1=s=>q((t=K(s))=>t),d1=()=>q((s=K(P.c.host))=>s),e5=()=>P.c.update,u1=(s,t,e=0)=>{let i={},o=!1;const c=()=>o,C=(l,a)=>{for(const f in i){const r=i[f];r.effect&&r.tag===l&&(r.value=r.effect(r.value,a))}};return{load:l=>{P.c={host:t,hooks:i,update:s,i:0,id:e};let a;try{o=!1,a=l()}catch(f){if(f!==p1)throw f;o=!0}finally{P.c=null}return a},cleanEffects:l=>(C(W,l),()=>(C(Q,l),()=>{C(X,l)})),isSuspense:c}},x=Symbol.for;function H1(s,t){const e=s.length;if(e!==t.length)return!1;for(let i=0;i<e;i++){let o=s[i],c=t[i];if(o!==c)return!1}return!0}const v=s=>typeof s=="function",E=s=>typeof s=="object",{isArray:v1}=Array,R=(s,t)=>(t?s instanceof HTMLStyleElement:!0)&&"hydrate"in((s==null?void 0:s.dataset)||{});function t1(s,t){let e;const i=o=>{let{length:c}=o;for(let C=0;C<c;C++){const h=o[C];if(h&&Array.isArray(h))i(h);else{const n=typeof h;if(h==null||n==="function"||n==="boolean")continue;n==="string"||n==="number"?(e==null&&(e=""),e+=h):(e!=null&&(t(e),e=null),t(h))}}};i(s),e!=null&&t(e)}const s1=(s,t,e)=>(s.addEventListener(t,e),()=>s.removeEventListener(t,e));class e1{constructor(t,e,i){this.message=e,this.target=t,this.value=i}}class m1 extends e1{}class _1 extends e1{}const S="Custom",M1=null,Z1={true:1,"":1,1:1};function P1(s,t,e,i,o){const{type:c,reflect:C,event:h,value:n,attr:l=E1(t)}=(e==null?void 0:e.name)!=S&&E(e)&&e!=M1?e:{type:e},a=(c==null?void 0:c.name)===S&&c.map,f=n!=null?c==Function||!v(n)?()=>n:n:null;Object.defineProperty(s,t,{configurable:!0,set(r){const p=this[t];f&&c!=Boolean&&r==null&&(r=f());const{error:u,value:H}=(a?V1:I1)(c,r);if(u&&H!=null)throw new m1(this,`The value defined for prop '${t}' must be of type '${c.name}'`,H);p!=H&&(this._props[t]=H??void 0,this.update(),h&&L1(this,h),this.updated.then(()=>{C&&(this._ignoreAttr=l,b1(this,c,l,this[t]),this._ignoreAttr=null)}))},get(){return this._props[t]}}),f&&(o[t]=f()),i[l]={prop:t,type:c}}const L1=(s,{type:t,base:e=CustomEvent,...i})=>s.dispatchEvent(new e(t,i)),E1=s=>s.replace(/([A-Z])/g,"-$1").toLowerCase(),b1=(s,t,e,i)=>i==null||t==Boolean&&!i?s.removeAttribute(e):s.setAttribute(e,(t==null?void 0:t.name)===S&&(t!=null&&t.serialize)?t==null?void 0:t.serialize(i):E(i)?JSON.stringify(i):t==Boolean?"":i),x1=(s,t)=>s==Boolean?!!Z1[t]:s==Number?Number(t):s==String?t:s==Array||s==Object?JSON.parse(t):s.name==S?t:new s(t),V1=({map:s},t)=>{try{return{value:s(t),error:!1}}catch{return{value:t,error:!0}}},I1=(s,t)=>s==null||t==null?{value:t,error:!1}:s!=String&&t===""?{value:void 0,error:!1}:s==Object||s==Array||s==Symbol?{value:t,error:{}.toString.call(t)!==`[object ${s.name}]`}:t instanceof s?{value:t,error:s==Number&&Number.isNaN(t.valueOf())}:s==String||s==Number||s==Boolean?{value:t,error:s==Number?typeof t!="number"?!0:Number.isNaN(t):s==String?typeof t!="string":typeof t!="boolean"}:{value:t,error:!0};let N1=0;const S1=s=>{var e;const t=((e=(s==null?void 0:s.dataset)||{})==null?void 0:e.hydrate)||"";return t||"c"+N1++},y1=(s,t=HTMLElement)=>{const e={},i={},o="prototype"in t&&t.prototype instanceof Element,c=o?t:"base"in t?t.base:HTMLElement,{props:C,styles:h}=o?s:t;class n extends c{constructor(){super(),this._setup(),this._render=()=>s({...this._props});for(const a in i)this[a]=i[a]}static get styles(){return[super.styles,h]}async _setup(){if(this._props)return;this._props={};let a,f;this.mounted=new Promise(w=>this.mount=()=>{w(),a!=this.parentNode&&(f!=a?this.unmounted.then(this.update):this.update()),a=this.parentNode}),this.unmounted=new Promise(w=>this.unmount=()=>{w(),(a!=this.parentNode||!this.isConnected)&&(r.cleanEffects(!0)()(),f=this.parentNode,a=null)}),this.symbolId=this.symbolId||Symbol(),this.symbolIdParent=Symbol();const r=u1(()=>this.update(),this,S1(this));let p,u=!0;const H=R(this);this.update=()=>(p||(p=!0,this.updated=(this.updated||this.mounted).then(()=>{try{const w=r.load(this._render),d=r.cleanEffects();return w&&w.render(this,this.symbolId,H),p=!1,u&&!r.isSuspense()&&(u=!1,!H&&T1(this)),d()}finally{p=!1}}).then(w=>{w&&w()})),this.updated),this.update()}connectedCallback(){this.mount(),super.connectedCallback&&super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),this.unmount()}attributeChangedCallback(a,f,r){if(e[a]){if(a===this._ignoreAttr||f===r)return;const{prop:p,type:u}=e[a];try{this[p]=x1(u,r)}catch{throw new _1(this,`The value defined as attr '${a}' cannot be parsed by type '${u.name}'`,r)}}else super.attributeChangedCallback(a,f,r)}static get props(){return{...super.props,...C}}static get observedAttributes(){const a=super.observedAttributes||[];for(const f in C)P1(this.prototype,f,C[f],e,i);return Object.keys(e).concat(a)}}return n};function T1(s){const{styles:t}=s.constructor,{shadowRoot:e}=s;if(e&&t.length){const i=[];t1(t,o=>{o&&(o instanceof Element?e.appendChild(o.cloneNode(!0)):i.push(o))}),i.length&&(e.adoptedStyleSheets=i)}}const F=s=>(t,e)=>{q(([i,o]=[])=>((o||!o)&&(o&&H1(o,e)?i=i||!0:(v(i)&&i(),i=null)),[i,e]),([i,o],c)=>c?(v(i)&&i(),[]):[i||t(),o],s)},i5=F(Q),o5=F(X),B1=F(W),k=x("atomico/options");globalThis[k]=globalThis[k]||{sheet:!!document.adoptedStyleSheets};const i1=globalThis[k];new Promise(s=>{i1.ssr||(document.readyState==="loading"?s1(document,"DOMContentLoaded",s):s())});const A1={checked:1,value:1,selected:1},O1={list:1,type:1,size:1,form:1,width:1,height:1,src:1,href:1,slot:1},R1={shadowDom:1,staticNode:1,cloneNode:1,children:1,key:1},N={},D=[];class j extends Text{}const k1=x("atomico/id"),b=x("atomico/type"),A=x("atomico/ref"),o1=x("atomico/vnode"),D1=()=>{};function j1(s,t,e){return n1(this,s,t,e)}const c1=(s,t,...e)=>{const i=t||N;let{children:o}=i;if(o=o??(e.length?e:D),s===D1)return o;const c=s?s instanceof Node?1:s.prototype instanceof HTMLElement&&2:0;if(c===!1&&s instanceof Function)return s(o!=D?{children:o,...i}:i);const C=i1.render||j1;return{[b]:o1,type:s,props:i,children:o,key:i.key,shadow:i.shadowDom,static:i.staticNode,raw:c,is:i.is,clone:i.cloneNode,render:C}};function n1(s,t,e=k1,i,o){let c;if(t&&t[e]&&t[e].vnode==s||s[b]!=o1)return t;(s||!t)&&(o=o||s.type=="svg",c=s.type!="host"&&(s.raw==1?(t&&s.clone?t[A]:t)!=s.type:s.raw==2?!(t instanceof s.type):t?t[A]||t.localName!=s.type:!t),c&&s.type!=null&&(s.raw==1&&s.clone?(i=!0,t=s.type.cloneNode(!0),t[A]=s.type):t=s.raw==1?s.type:s.raw==2?new s.type:o?document.createElementNS("http://www.w3.org/2000/svg",s.type):document.createElement(s.type,s.is?{is:s.is}:void 0)));const C=t[e]?t[e]:N,{vnode:h=N,cycle:n=0}=C;let{fragment:l,handlers:a}=C;const{children:f=D,props:r=N}=h;if(a=c?{}:a||{},s.static&&!c)return t;if(s.shadow&&!t.shadowRoot&&t.attachShadow({mode:"open",...s.shadow}),s.props!=r&&F1(t,r,s.props,a,o),s.children!==f){const p=s.shadow?t.shadowRoot:t;l=q1(s.children,l,p,e,!n&&i,o&&s.type=="foreignObject"?!1:o)}return t[e]={vnode:s,handlers:a,fragment:l,cycle:n+1},t}function $1(s,t){const e=new j(""),i=new j("");let o;if(s[t?"prepend":"append"](e),t){let{lastElementChild:c}=s;for(;c;){const{previousElementSibling:C}=c;if(R(c,!0)&&!R(C,!0)){o=c;break}c=C}}return o?o.before(i):s.append(i),{markStart:e,markEnd:i}}function q1(s,t,e,i,o,c){s=s==null?null:v1(s)?s:[s];const C=t||$1(e,o),{markStart:h,markEnd:n,keyes:l}=C;let a;const f=l&&new Set;let r=h;if(s&&t1(s,p=>{if(typeof p=="object"&&!p[b])return;const u=p[b]&&p.key,H=l&&u!=null&&l.get(u);r!=n&&r===H?f.delete(r):r=r==n?n:r.nextSibling;const w=l?H:r;let d=w;if(p[b])d=n1(p,w,i,o,c);else{const y=p+"";!(d instanceof Text)||d instanceof j?d=new Text(y):d.data!=y&&(d.data=y)}d!=r&&(l&&f.delete(d),!w||l?(e.insertBefore(d,r),l&&r!=n&&f.add(r)):w==n?e.insertBefore(d,n):(e.replaceChild(d,w),r=d)),u!=null&&(a=a||new Map,a.set(u,d))}),r=r==n?n:r.nextSibling,t&&r!=n)for(;r!=n;){const p=r;r=r.nextSibling,p.remove()}return f&&f.forEach(p=>p.remove()),C.keyes=a,C}function F1(s,t,e,i,o){for(const c in t)!(c in e)&&Y(s,c,t[c],null,o,i);for(const c in e)Y(s,c,t[c],e[c],o,i)}function Y(s,t,e,i,o,c){if(t=t=="class"&&!o?"className":t,e=e??null,i=i??null,t in s&&A1[t]&&(e=s[t]),!(i===e||R1[t]||t[0]=="_"))if(s.localName==="slot"&&t==="assignNode"&&"assign"in s)s.assign(i);else if(t[0]=="o"&&t[1]=="n"&&(v(i)||v(e)))U1(s,t.slice(2),i,c);else if(t=="ref")i&&(v(i)?i(s):i.current=s);else if(t=="style"){const{style:C}=s;e=e||"",i=i||"";const h=E(e),n=E(i);if(h)for(const l in e)if(n)!(l in i)&&G(C,l,null);else break;if(n)for(const l in i){const a=i[l];h&&e[l]===a||G(C,l,a)}else C.cssText=i}else{const C=t[0]=="$"?t.slice(1):t;C===t&&(!o&&!O1[t]&&t in s||v(i)||v(e))?s[t]=i??"":i==null?s.removeAttribute(C):s.setAttribute(C,E(i)?JSON.stringify(i):i)}}function U1(s,t,e,i){if(i.handleEvent||(i.handleEvent=o=>i[o.type].call(s,o)),e){if(!i[t]){const o=e.capture||e.once||e.passive?Object.assign({},e):null;s.addEventListener(t,i,o)}i[t]=e}else i[t]&&(s.removeEventListener(t,i),delete i[t])}function G(s,t,e){let i="setProperty";e==null&&(i="removeProperty",e=null),~t.indexOf("-")?s[i](t,e):s[t]=e}const z1=c1("host",{style:"display: contents"}),Y1="value",G1=(s,t)=>{const e=d1(),i=w1();B1(()=>s1(e.current,"ConnectContext",o=>{o.composedPath().at(0)!==o.currentTarget&&s===o.detail.id&&(o.stopPropagation(),o.detail.connect(i))}),[s]),i.current=t},J1=s=>{const t=y1(({value:e})=>(G1(t,e),z1),{props:{value:{type:Object,value:()=>s}}});return t[Y1]=s,t};J1({dispatch(s,t){}});const K1=0,M=1,V=2,I=3,J=4,L=5,$=6,C1=0,X1=2,r1=3,h1=4,l1=L,Q1=$,a1=(s,t,e,i)=>{let o;t[0]=0;for(let c=1;c<t.length;c++){const C=t[c++],h=t[c]?(t[0]|=C?1:2,e[t[c++]]):t[++c];C===r1?i[0]=h:C===h1?i[1]=Object.assign(i[1]||{},h):C===l1?(i[1]=i[1]||{})[t[++c]]=h:C===Q1?i[1][t[++c]]+=h+"":C?(o=s.apply(h,a1(s,h,e,["",null])),i.push(o),h[0]?t[0]|=2:(t[c-2]=C1,t[c]=o)):i.push(h)}return i},W1=function(s){let t=M,e="",i="",o=[0],c,C;const h=n=>{t===M&&(n||(e=e.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?o.push(C1,n,e):t===I&&(n||e)?(o.push(r1,n,e),t=V):t===V&&e==="..."&&n?o.push(h1,n,0):t===V&&e&&!n?o.push(l1,0,!0,e):t>=L&&((e||!n&&t===L)&&(o.push(t,0,e,C),t=$),n&&(o.push(t,n,0,C),t=$)),e=""};for(let n=0;n<s.length;n++){n&&(t===M&&h(),h(n));for(let l=0;l<s[n].length;l++)c=s[n][l],t===M?c==="<"?(h(),o=[o],t=I):e+=c:t===J?e==="--"&&c===">"?(t=M,e=""):e=c+e[0]:i?c===i?i="":e+=c:c==='"'||c==="'"?i=c:c===">"?(h(),t=M):t&&(c==="="?(t=L,C=e,e=""):c==="/"&&(t<L||s[n][l+1]===">")?(h(),t===I&&(o=o[0]),t=o,(o=o[0]).push(X1,0,t),t=K1):c===" "||c==="	"||c===`
`||c==="\r"?(h(),t=V):e+=c),t===I&&e==="!--"&&(t=J,o=o[0])}return h(),o},t5=new Map;function g(s){let t=t5;return t=a1(c1,t.get(s)||(t.set(s,t=W1(s)),t),arguments,[]),t.length>1?t:t[0]}function g1(s){var t,e,i="";if(typeof s=="string"||typeof s=="number")i+=s;else if(typeof s=="object")if(Array.isArray(s)){var o=s.length;for(t=0;t<o;t++)s[t]&&(e=g1(s[t]))&&(i&&(i+=" "),i+=e)}else for(e in s)s[e]&&(i&&(i+=" "),i+=e);return i}function c5(){for(var s,t,e=0,i="",o=arguments.length;e<o;e++)(s=arguments[e])&&(t=g1(s))&&(i&&(i+=" "),i+=t);return i}const n5=g`
  <svg
...
`;export{D5 as A,Z5 as B,P5 as C,L5 as D,E5 as E,b5 as F,x5 as G,B5 as H,m5 as I,a5 as J,y5 as K,j5 as L,u5 as M,k5 as N,h5 as O,I5 as P,R5 as Q,N5 as R,_5 as S,r5 as T,n5 as U,C5 as V,w5 as a,y1 as b,d5 as c,w1 as d,M5 as e,o5 as f,i5 as g,g as h,c5 as i,c1 as j,q as k,H1 as l,e5 as m,v as n,l5 as o,f5 as p,p5 as q,H5 as r,O5 as s,A5 as t,d1 as u,v5 as v,V5 as w,g5 as x,T5 as y,S5 as z};
